...
<html>
<head>
    <title>SDG 16: Promote just, peaceful and inclusive societies</title>
    ...
    <style type="text/css">
        ...
        .metric-title{
            ...
            font-weight: bold;
            margin-top: 0px;
            color: rgba(38,189,226,1);
            padding-top: 20px;
        }

        .hr-metric{
            border: solid 2px rgba(38,189,226,1);  
            width: 100px; 
            margin-left: 0;
            margin-top: 0;
        }
        ...
        .sdg-border{
            border-color:rgba(38,189,226,1);
        }
